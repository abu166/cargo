...
const translations = {
  ru: {
    ...
    // thisMonth removed to avoid duplicate key; Corporate section uses it
    ...
    // activeShipments removed to avoid duplicate key; Sidebar section uses it
    ...
    // shipmentsReport removed to avoid duplicate key; Manager/Reports section uses it
  ...
  kk: {
    // Top Bar
    stationName: 'Алматы-1 станциясы',
    search: 'Іздеу',
