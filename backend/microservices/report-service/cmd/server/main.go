...
import (
	...
	"cargo/backend/microservices/report-service/internal/config"
	"cargo/backend/microservices/report-service/internal/middleware"
)
...
func main() {
	...
	log.Printf("Starting Report Service on %s:%d", cfg.Server.Host, cfg.Server.Port)
