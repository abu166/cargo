...
import (
	...
	"cargo/backend/microservices/notification-service/internal/config"
	"cargo/backend/microservices/notification-service/internal/middleware"
)
...
func main() {
	...
	log.Printf("Starting Notification Service on %s:%d", cfg.Server.Host, cfg.Server.Port)
