...
import (
	...
	"cargo/backend/microservices/audit-service/internal/config"
	"cargo/backend/microservices/audit-service/internal/middleware"
)
...
func main() {
	...
	log.Printf("Starting Audit Service on %s:%d", cfg.Server.Host, cfg.Server.Port)
